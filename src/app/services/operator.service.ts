...
export class OperatorService {
  ...
  startProcess(start_info): Observable<any> {
    ...
    return this.http
      .post<{}>(baseUrl + 'start_process/', start_info, )
      .pipe(
        map((data) => {
          return data;
        }),
  ...
  endProcess(end_info): Observable<any> {
    return this.http
      .post<{}>(baseUrl + 'end_process/', end_info, httpOptions)
      .pipe(
        map((data) => {
          return data;
        }),
  ...
  getAllParts(): Observable<any> {
    ...
    return this.http
    .get<{}>(
      baseUrl + 'get_all_parts/', httpOptions
      )
  ...
  getInspection(payload:any): Observable<any> {
    ...
    return this.http
    .post<{}>(
      baseUrl + 'start_inspection/',payload
      )
  ...
  getCameraFeed(): Observable<any> {
    return this.http
      .get<{}>(baseUrl + 'get_camera_urls/', httpOptions)
      .pipe(
        map((data) => {
          return data;
        }),
